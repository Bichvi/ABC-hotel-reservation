...
<div class="container">
    <div class="wrapper">
        <div class="d-flex justify-content-between align-items-center mb-4 pb-3 border-bottom border-secondary">
            ...
            <a href="index.php?controller=dashboard&action=cskh" class="btn btn-sm btn-outline-secondary">Quay lại</a>
        </div>

        <form action="index.php?controller=cskh&action=guiThongBao" method="POST" onsubmit="return confirm('Xác nhận gửi email?');">
