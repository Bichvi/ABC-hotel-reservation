...
$cartCount = isset($_SESSION['cart_rooms'])
    ? count($_SESSION['cart_rooms'])
    : 0;
...
<div class="container py-4">
    ...
    <div class="d-flex justify-content-end mb-3">
        <a href="index.php?controller=khachhang&action=viewCart"
        class="btn btn-outline-info">
            <i class="fa-solid fa-cart-shopping"></i>
            Xem giỏ phòng
            <?php if (!empty($_SESSION['cart_rooms'])): ?>
                (<?= count($_SESSION['cart_rooms']) ?>)
            <?php endif; ?>
        </a>
    </div>
                ...
                <div class="col-md-4">
                    <div class="room-card p-3">
                        ...
                        <form method="GET" action="index.php">
                            ...
                            <button class="btn-book w-100 mt-2">
