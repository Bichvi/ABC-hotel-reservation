...
<head>
    <meta charset="UTF-8">
    <title>Thêm chi phí - Kế toán</title>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="form-card p-4">
                <h2 class="form-title">
                    <i class="fa-solid fa-plus-circle me-2" style="color: #22c55e;"></i>Thêm chi phí
                </h2>
                <p class="form-subtitle">Ghi nhận chi phí vận hành cho resort</p>
                ...
                <form method="POST" class="needs-validation" novalidate>
                    ...
                    <div class="mb-4">
                        ...
                        <select class="form-select" id="TrangThai" name="TrangThai" required>
                            <option value="ChoDuyet" <?= ($input['TrangThai'] ?? 'ChoDuyet') === 'ChoDuyet' ? 'selected' : '' ?>>Chờ duyệt</option>
                            <option value="DaDuyet" <?= ($input['TrangThai'] ?? 'ChoDuyet') === 'DaDuyet' ? 'selected' : '' ?>>Đã duyệt</option>
                            <option value="Huy" <?= ($input['TrangThai'] ?? 'ChoDuyet') === 'Huy' ? 'selected' : '' ?>>Đã hủy</option>
                        </select>
                    </div>

                    <div class="btn-group-actions">
                        <button type="submit" class="btn btn-submit">
                            <i class="fa-solid fa-check me-2"></i>Thêm chi phí
                        </button>
