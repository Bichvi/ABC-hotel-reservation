...
<!--  vi=============quản lí thong báo emai - chat 1:1 -->
        ...
        <!-- 5. Gửi thông báo qua email -->
         <div class="col-md-4">
            <a href="index.php?controller=quanly&action=kiemTraKhuyenMai" class="text-decoration-none text-light">
                <div class="card card-module p-3 h-100" style="background: radial-gradient(circle at top left, rgba(16, 185, 129, 0.25), rgba(15,23,42,0.95));">
                    <div class="d-flex justify-content-between mb-3">
                        <div class="icon-circle">
                            <i class="fa-solid fa-gift fa-lg" style="color: #86efac !important;"></i>
                        </div>
                        <span class="quick-pill"><i class="fa-solid fa-ticket"></i>Kiểm tra</span>
                    </div>

                    <h5 class="mb-1">Kiểm tra khuyến mãi</h5>
                    <p class="small text-secondary mb-2">
                        Quản lý các khoản khuyến mãi giảm giá hay miễn phí đã và đang áp dụng.
                    </p>

                    <div class="d-flex justify-content-between small">
                        <span><i class="fa-solid fa-chart-line me-1"></i>Chiến dịch</span>
                        <i class="fa-solid fa-arrow-right"></i>
                    </div>
                </div>
            </a>
